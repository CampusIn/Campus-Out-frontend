/* eslint-disable */
import { X, Eye, EyeOff, Lock, Store } from 'lucide-react';
...
export default function VendorLogin() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setError('');
    const result = await login(form.email, form.password, 'vendor');
    if (result.success) {
      ...
      {showSessionExpiredModal && (
        <div className="session-expired-modal-overlay">
          <div className="session-expired-modal-card animate-scale-in">
            <div className="session-expired-icon-wrapper vendor-accent-bg">
            ...
            <p className="session-expired-text">
              For your security, your session has timed out. Please log in again to continue managing your restaurant.
            </p>
            <button 
              className="session-expired-btn vendor-accent-btn"
      ...
      <div className="swiggy-auth-card animate-scale-in">
        ...
        <div className="swiggy-auth-header-row">
          <div className="swiggy-auth-title-col">
            <h1 className="swiggy-auth-title">Vendor Login</h1>
            <p className="swiggy-auth-subtitle">
              or <Link to="/vendor/register" className="swiggy-auth-link vendor-link">create a vendor account</Link>
            </p>
        ...
        <form onSubmit={handleSubmit} className="swiggy-auth-form">
            ...
            <div className="swiggy-auth-error-msg animate-shake">
              ...
              {error === 'Please verify your email before logging in' && (
                <button 
                  type="button" 
                  onClick={async () => {
                    await resendOtp(form.email, 'vendor');
          ...
          <div className="swiggy-inputs-stack">
            ...
            <div className="swiggy-input-container border-bottom-none">
              <input 
                ...
                required 
              />
              <label htmlFor="vendor-email" className="swiggy-label">Email Address</label>
            </div>
          ...
          <Link to="/forgot-password?role=vendor" className="swiggy-forgot-password vendor-link">
            Forgot Password?
          </Link>
        ...
        <p className="swiggy-auth-footer-text" style={{ marginTop: '8px' }}>
          Not a vendor? <Link to="/login" className="swiggy-auth-link vendor-link" style={{ fontSize: '0.75rem' }}>Login as a customer</Link>
        </p>
      </div>
